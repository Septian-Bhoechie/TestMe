  ...
  <div class="row" v-if="examArray.length > 0">
        ...
        <span
          ...
          v-bind:class="{
            active: currentQuestion
              ? currentQuestion.id == questions[index].id
              : false,
          }"
          @click.prevent="
            editorDisabled = true;
    ...
    <div class="col-md-10 bg-white">
      ...
      <p class="text-center" style="color: #ff5500">
        <small
          >(Note: Click the checkbox beside an option to mark it as the correct
          option)</small
        >
      </p>
      <hr />
...
export default {
  ...
  methods: {
    ...
    updateQuestion() {
      ...
      const options = [
        { id: this.currentQuestion.options[0].id, value: optionA },
        { id: this.currentQuestion.options[1].id, value: optionB },
        { id: this.currentQuestion.options[2].id, value: optionC },
        { id: this.currentQuestion.options[3].id, value: optionD },
      ];

      this.$http
        .post(`updateQuestion/${this.currentQuestion.id}`, {
          question,
          options,
          correct,
        })
        .then((res) => {
          ...
          let index = this.questions.findIndex(
            (question) => question.id == res.data.question.id
          );
